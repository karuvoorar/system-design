...
/**
 * Idea is to have an interface which can provide characteristics of object
 * creational for multiple factories which is wrapped.
 *
 * Simply service -> (interface with groups classes)  ->  dependent on various
 * factories
 *
 * cons:
 * - Lengthier code base to handle
 * - Consistency issues with multiple person handling
 * - Testing is boilerplate
 * - Over engineering
 *
 * pros:
 * - consistency in handling since we don't touch core logic
 * - Scaling
 * - Reliability since it going to hardly change
 */
